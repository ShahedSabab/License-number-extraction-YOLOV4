...
• The performance achived from the mdoel is Mean Average Precision, mAP = 91%. <br>
• The model can detect multiple ROI's (license plate images). <br>
• Google Vision API is used as to extract the numbers/letters from the detected license plates. <br>
